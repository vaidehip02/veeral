...
const CONTENT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Payout Statuses", body: <><P>Your payout status in the seller dashboard reflects where your funds are in the release cycle:</P><Ul items={["In [N]d — payout is held; the number shows how many days remain until automatic release","Due — hold period has ended; release is processing","Released — funds have been transferred to your Stripe connected account; bank arrival takes 2–7 business days","Frozen — a dispute or admin review is in progress; the payout is paused until resolved","Blocked — your Stripe Connect onboarding is incomplete; the payout will be held until you finish connecting your account at Dashboard → Earnings"]} /></> },
