...
const CONTENT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Choosing a shipping tier", body: <><P>When creating a listing, choose the tier that best matches your item:</P><Ul items={["Small ($8) — jewellery, accessories, dupatta, stole, lightweight scarves","Medium ($14) — saree, kurta, salwar kameez, lehenga blouse only, indo-western","Large ($24) — lehenga set, sherwani, heavy bridal pieces","Custom ($5–$45) — use this if your item is unusually light (a single cotton scarf may ship for $5–7) or unusually heavy/oversized (a full bridal lehenga with can-can and accessories may exceed $30). Choosing the wrong tier means you absorb the difference — the label costs what it costs.","Free shipping — the buyer sees $0 at checkout. You still buy the label out of pocket. Consider raising your item price to offset the cost."]} /><P>The custom tier accepts any amount between $5 and $45. If you&apos;re genuinely unsure what your item will cost to ship, weigh it first — most carriers offer price calculators on their websites before you commit to a label purchase.</P></> },
