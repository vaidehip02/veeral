...
const CONTENT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Who pays for shipping? Do I need to buy a label?", body: <><P>The buyer pays an $18 shipping fee at checkout. That $18 is included in your payout — it is passed through to you to cover the cost of your label. You are responsible for purchasing your own shipping label through USPS, UPS, or FedEx and mailing the item.</P><P>There is no in-app label purchase flow. You buy the label directly from the carrier and enter the resulting tracking number in your dashboard.</P></> },
