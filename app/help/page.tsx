      ...
      <div className="max-w-5xl mx-auto" style={{ padding: "3rem 1.5rem 6rem" }}>
        ...
        <div style={{ marginBottom: "3.5rem" }}>
          ...
          <div style={{ background: "#fff", border: "1px solid var(--warm-tan)" }}>
            {[
              { q: "How do I ship my item?", a: "Ship within 7 days of purchase using USPS, UPS, or FedEx with tracking. Once shipped, go to Dashboard → Orders and click \"Mark as shipped\" to enter your tracking number. Tracking confirms shipment and is required for your payout to process — your payout goes out at the time of purchase, not after delivery." },
