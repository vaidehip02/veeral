...
// Each section is a list of {title, content} accordion items
const CONTENT_SECTIONS: { id: string; label: string; icon: string; items: { title: string; body: React.ReactNode }[] }[] = [
  {
    ...
    items: [
      ...
      {
        title: "Saving Drafts",
        body: <P>You can save a listing as a draft at any time and return to it later. Drafts are accessible across devices as long as you&apos;re logged in to your Veeral account.</P>,
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        title: "Shipping Requirements for Sellers",
        body: <>
          <Ul items={[
      ...
      {
        title: "Preparing Your Item for Shipment",
        body: <>
  ...
  },
  {
    ...
    items: [
      {
        title: "Finding Items",
        body: <P>Browse by category, garment type, occasion, size, or fabric using the search and filter tools on the Veeral homepage. You can also save items to your wishlist to revisit later.</P>,
      },
      {
        title: "Making an Offer",
        body: <P>Some listings allow buyers to make an offer below the listed price. If a seller accepts your offer, the item will be held for you to complete purchase. Offers expire after 24 hours if not accepted.</P>,
      },
      {
        title: "Checking Out",
        body: <>
      ...
      {
        title: "Buyer Protection — What's Covered",
        body: <>
      ...
      {
        title: "Buyer Protection — What's Not Covered",
        body: <Ul items={[
      ...
      },
      {
        ...
        body: <P>Report the issue through Veeral within 7 days of confirmed delivery. Provide photos and details of the discrepancy and follow the instructions from our support team. When returning: use a tracked shipping provider, package the item securely, and return all pieces in their original condition. Refunds are typically issued once the item is received by the seller.</P>,
      },
      {
    ...
    items: [
      {
        ...
        body: <P>Sellers (owners) specify the rental price per day or flat event rate, minimum and maximum rental duration, included pieces, care instructions, and availability. Renters specify their requested start date and number of days — the return-by date is then auto-calculated.</P>,
      },
      {
      ...
      },
      {
        ...
        body: <P>Rental items must be returned in the same condition they were received, aside from normal wear. Damage beyond normal wear includes stains, tears or holes, and missing embellishments or pieces.</P>,
      },
      {
        title: "Security Deposits & Late Fees",
        body: <>
          ...
          <P>Late returns may result in additional daily fees. If an item is not returned within 48 hours of the return-by date without communication, the full security deposit will be forfeited. Continued non-return may result in account suspension.</P>
        </>,
      },
    ],
  },
    ...
    items: [
      {
        ...
        body: <P>A payout is the money you receive from a completed sale. Funds are sent to your linked bank account after delivery is confirmed. Veeral&apos;s commission is automatically deducted before the payout is issued.</P>,
      },
      {
        title: "When You'll Receive Your Payout",
        body: <Ul items={[
      ...
      {
        title: "Pending or On-Hold Payments",
        body: <>
      ...
      {
        title: "Common Payout Issues",
        body: <P>Payouts may be delayed if bank details are incorrect or missing, account verification is incomplete, or a refund caused a negative balance.</P>,
      },
      {
        title: "Rental Returns & Deposits",
        body: <P>Rental items must be shipped back by the listed return-by date using tracked shipping. The security deposit is refunded in full after a clean return. Veeral may assist in resolving disputes related to rental conditions, damage, or timing.</P>,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        title: "Logging In",
        body: <P>Access your Veeral account via the website using your registered email and password. If you&apos;ve forgotten your password, use the &ldquo;Forgot Password&rdquo; link on the login page.</P>,
      },
      {
        title: "Managing Your Account",
        body: <P>From your account settings you can update your profile information, linked bank account for payouts, notification preferences, and saved addresses.</P>,
      },
      {
        title: "Technical Issues",
        body: <P>If you experience a technical problem, try refreshing the page or clearing your browser cache. If the issue persists, contact Veeral Support through the website.</P>,
      },
    ],
  },
];
...
// ── Sub-item accordion (individual topic) ────────────────────────────────────
...
function SectionAccordion({ section }: { section: typeof CONTENT_SECTIONS[0] }) {
  const [open, setOpen] = useState(false);
  return (
...
export default function HelpCenterPage() {
  ...
  const allItems = CONTENT_SECTIONS.flatMap(s =>
    ...
    <div style={{ background: "var(--cream)", minHeight: "100vh" }}>
      ...
      <div style={{ background: "#EDE6DE", padding: "4.5rem 1.5rem 3.5rem", textAlign: "center", borderBottom: "1px solid var(--warm-tan)" }}>
        ...
        {searchResults.length > 0 && (
          <div style={{ maxWidth: "540px", margin: "-0.5rem auto 1.25rem", background: "#fff", border: "1px solid var(--warm-tan)", boxShadow: "0 4px 20px rgba(0,0,0,0.08)", textAlign: "left", position: "relative", zIndex: 10 }}>
