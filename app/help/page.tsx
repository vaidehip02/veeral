...
const CONTENT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Possible Outcomes", body: <><Ul items={["Full refund to buyer and return of item to seller","Partial refund issued to buyer","Dispute dismissed — no action taken"]} /><P>Veeral&apos;s decision is final for transactions conducted through the platform.</P></> },
    ],
  },
  {
