...
const CONTENT_SECTIONS: ContentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Common Payout Issues", body: <><P>If your payout has not arrived:</P><Ul items={["Stripe Connect onboarding is incomplete — go to Dashboard → Earnings to finish connecting your account","Bank details on file are incorrect or your account verification is pending — check your Stripe Express dashboard","A dispute was opened and the payout was frozen pending resolution","A refund caused a negative balance — this must be resolved before the next payout processes"]} /></> },
