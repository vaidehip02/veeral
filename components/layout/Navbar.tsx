...
const NAV_LINKS = [
  ...
  { label: "Sell",   href: "/dashboard/listings" },
...
export default function Navbar() {
  ...
  const isSeller = !!user; // all logged-in users can access seller dashboard
      ...
      >
        <div className="flex items-center justify-between h-16 md:h-24 gap-6">
          ...
          <div className="hidden md:flex items-center gap-6 ml-auto">
            ...
            {/* Wishlist icon */}
            <Link href="/account/saved" aria-label="Saved" style={{ color: "var(--muted)" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
